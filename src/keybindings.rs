    ...
    fn default() -> Self {
        let context_bindings = hash_map_of!(
            InputContext::Note => hash_map_of!(
                ...
                KeyCode::Digit1 => b!(Event::State(model::Command::SetNoteFieldToCut)),
            ),
            InputContext::Octave => hash_map_of!(
                KeyCode::Digit0 => b!(Event::State(model::Command::SetOctaveField(OctaveValue::OCTAVE_0))),
                KeyCode::Digit1 => b!(Event::State(model::Command::SetOctaveField(OctaveValue::OCTAVE_1))),
                KeyCode::Digit2 => b!(Event::State(model::Command::SetOctaveField(OctaveValue::OCTAVE_2))),
                KeyCode::Digit3 => b!(Event::State(model::Command::SetOctaveField(OctaveValue::OCTAVE_3))),
                KeyCode::Digit4 => b!(Event::State(model::Command::SetOctaveField(OctaveValue::OCTAVE_4))),
                KeyCode::Digit5 => b!(Event::State(model::Command::SetOctaveField(OctaveValue::OCTAVE_5))),
                KeyCode::Digit6 => b!(Event::State(model::Command::SetOctaveField(OctaveValue::OCTAVE_6))),
                KeyCode::Digit7 => b!(Event::State(model::Command::SetOctaveField(OctaveValue::OCTAVE_7))),
                KeyCode::Digit8 => b!(Event::State(model::Command::SetOctaveField(OctaveValue::OCTAVE_8))),
                KeyCode::Digit9 => b!(Event::State(model::Command::SetOctaveField(OctaveValue::OCTAVE_9))),
            ),
            InputContext::Hex => hash_map_of!(
                KeyCode::Digit0 => b!(Event::State(model::Command::SetHexField(HexDigit::HEX_0))),
                KeyCode::Digit1 => b!(Event::State(model::Command::SetHexField(HexDigit::HEX_1))),
                KeyCode::Digit2 => b!(Event::State(model::Command::SetHexField(HexDigit::HEX_2))),
                KeyCode::Digit3 => b!(Event::State(model::Command::SetHexField(HexDigit::HEX_3))),
                KeyCode::Digit4 => b!(Event::State(model::Command::SetHexField(HexDigit::HEX_4))),
                KeyCode::Digit5 => b!(Event::State(model::Command::SetHexField(HexDigit::HEX_5))),
                KeyCode::Digit6 => b!(Event::State(model::Command::SetHexField(HexDigit::HEX_6))),
                KeyCode::Digit7 => b!(Event::State(model::Command::SetHexField(HexDigit::HEX_7))),
                KeyCode::Digit8 => b!(Event::State(model::Command::SetHexField(HexDigit::HEX_8))),
                KeyCode::Digit9 => b!(Event::State(model::Command::SetHexField(HexDigit::HEX_9))),
            ),
            ...
            InputContext::Global => hash_map_of!(
                ...
                KeyCode::ArrowLeft => b!(Event::Action(event::Action::Move(Direction::Left))),
                KeyCode::ArrowRight => b!(Event::Action(event::Action::Move(Direction::Right))),
                KeyCode::Insert => b!(Event::State(model::Command::CreateNewPattern)),
                KeyCode::NumpadAdd => b!(Event::State(model::Command::GoToNextPattern)),
                KeyCode::NumpadSubtract => b!(Event::State(model::Command::GoToPreviousPattern)),
                KeyCode::Delete => b!(Event::State(model::Command::ClearField)),
                KeyCode::Space => b!(Event::Action(event::Action::TogglePlay)),
                KeyCode::NumpadMultiply => b!(Event::State(model::Command::ChangeGlobalOctave { increment: 1 })),
                ...
                KeyCode::PageUp => b!(Event::Action(event::Action::ChangeSelectedInstrument { increment: -1 })),
            ),
